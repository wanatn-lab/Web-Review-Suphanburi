...
const REVIEW_COLUMNS = "id, title, slug, description, category, cover_image, facebook_embed_url, tiktok_embed_url, youtube_embed_url, google_map_embed_url, latitude, longitude, location_text, facebook_post_id, youtube_video_id, created_at, deleted_at, categories(label)";
