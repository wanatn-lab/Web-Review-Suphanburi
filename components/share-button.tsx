...
export default function ShareButton({
  ...
  return (
    <button
      type="button"
      onClick={handleShare}
      className={`inline-flex items-center justify-center gap-1.5 rounded-full border border-[#FFDD00] bg-[#FFDD00] font-semibold text-[#5C4400] transition hover:brightness-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFDD00] focus-visible:ring-offset-2 ${
        compact ? "min-h-9 px-3 py-1 text-[0.7rem]" : "min-h-11 px-3 py-1.5 text-xs"
      }`}
    >
